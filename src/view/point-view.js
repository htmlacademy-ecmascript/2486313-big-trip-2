...
export default class NewPointView extends AbstractView{
  ...
  #handleClickOpenPoint = null;

  constructor({points, offers, destinations, onClickFavorite, onClickOpenPoint}) {
    super();
    this.#points = points;
    this.#offers = offers;
    this.#destinations = destinations;
    this.#handleClickFavorite = onClickFavorite;
    this.#handleClickOpenPoint = onClickOpenPoint;

    this.element.querySelector('.event__rollup-btn').addEventListener('click', this.#handleClickOpenPoint);
